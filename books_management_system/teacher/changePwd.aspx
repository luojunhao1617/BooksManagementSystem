<%@ Page Title="" Language="C#" MasterPageFile="~/teacher/Teach.Master" AutoEventWireup="true" CodeBehind="changePwd.aspx.cs" Inherits="books_management_system.teacher.changePwd" %>
<%@ MasterType TypeName="books_management_system.teacher.Teach" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <p>
&nbsp;旧 密 码：<asp:TextBox ID="txtOldPwd" runat="server" OnTextChanged="txtOldPwd_TextChanged" TextMode="Password"></asp:TextBox>
    </p>
    <p>
